      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-6 pt-5">
            <img src="/logos/linkedin.svg" className="h-7 opacity-70 hover:opacity-100 transition" />
            <img src="/logos/facebook.svg" className="h-8 opacity-70 hover:opacity-100 transition" />
          </div>

          {/* 🌤️ GLASS WEATHER CARD */}
          <div className="mt-6">
